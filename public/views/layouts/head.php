...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="https://artra-artvisory.com/" />
        <link rel="apple-touch-icon" sizes="48x48" href="<?= BASE_URL; ?>/public/assets/icon/favicon.ico">
        <link rel="icon" sizes="48x48" href="<?= BASE_URL; ?>/public/assets/icon/favicon.ico">
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
        <link rel="preload" href="<?= BASE_URL; ?>/public/assets/font/CenturyOldStyleStd-Regular.ttf" as="font" type="font/ttf" crossorigin>
        <link rel="preload" href="<?= BASE_URL; ?>/public/assets/font/CenturyOldStyleStd-Italic.ttf" as="font" type="font/ttf" crossorigin>
		...
		<script src="<?= BASE_URL; ?>/public/assets/js/menu.js" defer></script>
        <script src="<?= BASE_URL; ?>/public/assets/js/catalogue.js" defer></script>
    </head>