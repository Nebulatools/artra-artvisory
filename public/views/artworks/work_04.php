<main class="artworks-main-50">
    <section class="artworks-section-50">
        <div class="artworks-image-50">
            <img class="artworks-img-50" src="<?= BASE_URL; ?>public/assets/image/artwork_detail/svg-01.svg" alt="Title">
        </div>
    </section>
    <section class="artworks-section-52">
        <div class="artworks-content-50">
            ...
            <div class="dual-left-column-50">
                <div class="dual-image-50">
                    <picture>
                        ...
                        <img class="dual-img-51" src="<?= BASE_URL; ?>public/assets/image/artwork_detail/04-01.png" alt="Artwork Image">
                    </picture>
                </div>
            </div>
