<main class="hwdi-main-30">
    ...
    <section class="dual-section-30">
        <div class="dual-grid-30">
            <div class="dual-left-column-30">
                <div class="dual-content-30">
                    <div class="left-description-30">
                        Our process is both intuitive and methodical &#8212;
                        from concept sketch to final installation.<br>
                        We prototype, test and refine, balancing color,
                        grain and scale.
                        <br><br>
                        <i>
                            Every line reconsidered until it feels right &#8212;
                            until the piece feels inevitable,
                            as if it always belonged together.
                        </i>
                    </div>
                </div>
            </div>
    ...
    <section class="dual-section-30">
        <div class="dual-grid-30">
            ...
            <div class="dual-right-column-31">
                <div class="dual-content-30">
                    <div class="right-description-30">
                        Detail by detail, we step back until only
                        the art remains.<br>
                        Perfect alignment, subtle shadow,
                        a weightless presence.
                        <br><br>
                        <i>
                            Our job is to let the work stand out &#8212;
                            with the clarity and grace it deserves.
                        </i>
                    </div>
                </div>
            </div>
